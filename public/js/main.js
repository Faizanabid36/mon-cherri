	...
	/*-----------------------------------------
	 ...
	 /*-----------------------------------------
	  ...
	  function minicart_dropdown(){
		$(".site-header__cart3").on("click", function(i) {
			i.preventDefault();
			$(".site-header3").slideToggle();
		});
		$(".site-header__cart2").on("click", function(i) {
			i.preventDefault();
			$(".site-header2").slideToggle();
		});
		$(".site-header__cart1").on("click", function(i) {
			i.preventDefault();
			$(".site-header1").slideToggle();
		});
		// Hide Cart on document click
		$("body").on("click", function(event ) {
		  var $target = $(event.target);
		  if(!$target.parents().is(".site-cart") && !$target.is(".site-cart")){
			$("body").find(".site-header").slideUp();
		  }
		});
        // $("body").on("click", function(event ) {
        //     var $target = $(event.target);
        //     if(!$target.parents().is(".site-cart2") && !$target.is(".site-cart2")){
        //       $("body").find(".site-header2").slideUp();
        //     }
        //   });
        //   $("body").on("click", function(event ) {
        //     var $target = $(event.target);
        //     if(!$target.parents().is(".site-cart3") && !$target.is(".site-cart3")){
        //       $("body").find(".site-header2").slideUp();
        //     }
        //   });
	  }
    ...
    function myFunction() {
      if($(window).width()>1199) {
            if($(window).scrollTop()>145){
              ...
              $('.header-wrap').removeClass("fadeOutUp");
            }
       }
    }
