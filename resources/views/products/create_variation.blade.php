                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control @error('sizes') is-invalid @enderror"
                                                    ...
                                                    @foreach(App\Size::all() as $size)
                                                        ...
                                                        <?php
                                                            if (!is_null(json_decode($product->sizes))) {
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group"><label>Width</label>
                                                <select class="form-control @error("widths") is-invalid @enderror"
                                                        id="widths" data-route="" name="widths[]" multiple>
                                                    ...
                                                    @foreach(App\Width::all() as $width)
                                                        ...
                                                        <?php
                                                            if (!is_null(json_decode($product->widths))) {
                                        ...
                                        <td>
                                            <div class="actions">
                                                <button data-id="{{$variation->id}}"
                                                        class="btn btn-sm bg-success-light mr-2 edit_btn"><i
