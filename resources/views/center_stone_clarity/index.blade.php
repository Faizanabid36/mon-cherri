@extends('layouts.app')
@section('title', 'Dashboard - Center Stone Clarity')
@section('content')
    <div class="content container-fluid">
            ...
            <div class="row">
                <div class="col">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Stone Clarity</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Clarity Details</h4>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                @endif
                                <span class="badge badge-primary">add new clarity</span>
                                <form action="{{route('center_stone.clarity.store')}}" method="post">
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-12">
            ...
            <div class="col-sm-6">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Store Clarity</h4>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="table-responsive">
                                    <table class="table datatable">
                                        ...
                                        <tbody>
                                        <?php $count = 1; ?>
                                        @foreach($center_stone_clarities as $variation)
                                            <tr>
                                                <td><?=$count++?></td>
