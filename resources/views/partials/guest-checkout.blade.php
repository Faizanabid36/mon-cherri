    ...
    <fieldset>
        ...
        <div class="row">
            <div class="form-group col-md-6 col-lg-6 col-xl-6 required">
                ...
                <input class="form-control @error('first_name') is-invalid @enderror" name="first_name"  id="firstname" type="text" required>
            ...
            <div class="form-group col-md-6 col-lg-6 col-xl-6 required">
               <label for="lastname">{{__('Last Name')}}<span>*</span></label>
                <input class="form-control @error('last_name') is-invalid @enderror" name="last_name" id="lastname" type="text" required>
        ...
        <div class="row">
            ...
            <div class="form-group col-md-6 col-lg-6 col-xl-6 required">
                ...
                <input class="form-control @error('phone') is-invalid @enderror" name="phone" type="tele" id="phone" required>
                @if($errors->has('phone'))
    ...
    <fieldset>
        <div class="row">
            <div class="form-group col-md-12 col-lg-12 col-xl-12 required">
                 ...
                 <textarea class="form-control @error('address') is-invalid @enderror" name="address" id="address" placeholder="Write your full address please..." required></textarea>
